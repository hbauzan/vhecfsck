...
> *Cites `roadmap/02-metrics-spec.md` — 1. Common conventions*


### 1.1 Metric spaces

> *Cites `roadmap/02-metrics-spec.md` — 1.1 Metric spaces*
...
> *Cites `roadmap/02-metrics-spec.md` — 1.2 Determinism*
...
> *Cites `roadmap/02-metrics-spec.md` — 1.3 Metric result states*
...
[ADR-0004](https://github.com/hbauzan/vhecfsck/blob/main/roadmap/adr/0004-metric-result-states-and-exit-codes.md).

### 1.4 Evidence strength

> *Cites `roadmap/02-metrics-spec.md` — 1.4 Evidence strength*
...
> *Cites `roadmap/02-metrics-spec.md` — 1.5 Threshold direction*
...
> *Cites `roadmap/02-metrics-spec.md` — 1.6 Global input validation*
...
> *Cites `roadmap/02-metrics-spec.md` — 2. M1 — Canary Recall*
...
> *Cites `roadmap/02-metrics-spec.md` — 2.1 The question*
...
> *Cites `roadmap/02-metrics-spec.md` — 2.2 Definition*
...
> *Cites `roadmap/02-metrics-spec.md` — 2.3 Algorithm*
...
> *Cites `roadmap/02-metrics-spec.md` — 2.4 Query set resolution*
...
> *Cites `roadmap/02-metrics-spec.md` — 2.5 Edge cases (all require a test)*
...
> *Cites `roadmap/02-metrics-spec.md` — 2.6 Oracle and test vectors*
...
> *Cites `roadmap/02-metrics-spec.md` — 2.7 Report fields*
...
> *Cites `roadmap/02-metrics-spec.md` — 3. M2/M3 — Hubness: Top-1% Hub Share and Anti-Hub Fraction*
...
> *Cites `roadmap/02-metrics-spec.md` — 3.1 [CORRECTION 3] The sampling regime — read this before implementing*
...
See [ADR-0006](https://github.com/hbauzan/vhecfsck/blob/main/roadmap/adr/0006-hubness-sampling-regime.md).

### 3.2 Comparability constraint

> *Cites `roadmap/02-metrics-spec.md` — 3.2 Comparability constraint*
...
> *Cites `roadmap/02-metrics-spec.md` — 3.3 Source: intrinsic vs effective*
...
> *Cites `roadmap/02-metrics-spec.md` — 3.4 Cost*
...
> *Cites `roadmap/02-metrics-spec.md` — 3.5 Additional diagnostics (reported, not gated)*
...
> *Cites `roadmap/02-metrics-spec.md` — 3.6 Edge cases (all require a test)*
...
> *Cites `roadmap/02-metrics-spec.md` — 3.7 Oracle and test vectors*
...
> *Cites `roadmap/02-metrics-spec.md` — 4. M4 — Deletion Fragmentation Index (DFI)*
...
> *Cites `roadmap/02-metrics-spec.md` — 4.1 Definition*
...
> *Cites `roadmap/02-metrics-spec.md` — 4.2 Per-engine derivation, and where it gets subtle*
...
> *Cites `roadmap/02-metrics-spec.md` — 4.4 Edge cases*
...
> *Cites `roadmap/02-metrics-spec.md` — 5. M5 — Partition Size CV (IVF)*
...
> *Cites `roadmap/02-metrics-spec.md` — 5.1 Definition*
...
> *Cites `roadmap/02-metrics-spec.md` — 5.2 Companion diagnostics (reported, not gated)*
...
> *Cites `roadmap/02-metrics-spec.md` — 5.3 Edge cases*
...
> *Cites `roadmap/02-metrics-spec.md` — 5.4 Oracle and test vectors*
...
> *Cites `roadmap/02-metrics-spec.md` — 6. Verdict aggregation*
...
Exit codes, per [ADR-0004](https://github.com/hbauzan/vhecfsck/blob/main/roadmap/adr/0004-metric-result-states-and-exit-codes.md):
...
> *Cites `roadmap/02-metrics-spec.md` — 7. Metrics deliberately deferred*

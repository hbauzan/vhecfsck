...
Antes de cualquier tarea de implementación, bug, review o entrega, aplicá el protocolo en [`.agents/skills/dev-protocol/SKILL.md`](.agents/skills/dev-protocol/SKILL.md).
